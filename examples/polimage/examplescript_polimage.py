...
# polarized image plot
polimageplot = dm.plotting.plot_polimage(modelinfo,'mean',smooth=17.0)
polimageplot.savefig('polarized_image.png',dpi=300)
plt.close(polimageplot)
